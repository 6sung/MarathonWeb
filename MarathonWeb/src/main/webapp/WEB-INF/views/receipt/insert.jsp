...
<head>
   <!-- Required meta tags -->
   <meta charset="utf-8">
   <jsp:include page="../marathon/navtest.jsp" />
   ...
   <div class="container px-4 px-lg-5 my-5">
      <div class="row gx-4 gx-lg-5 align-items-center">
         ...
         <div class="col-md-6">
            ...
            <div class="row mb-3">
            <label for="Marathon_id" class="col-sm-3 col-form-label">마라톤 id(임시)</label>
            <div class="col-sm-9">
            <input type="text" id="50" class="form-control" name="marathonId" value="${marathon.marathonId}">
               </div>
            </div>
